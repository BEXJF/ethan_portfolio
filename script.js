...
const translations = {
  en: {
    ...
    text: {
      ...
      ".exp-card:nth-child(5) .tag": "Industry",
      ".exp-card:nth-child(5) .exp-period": "Fall 2026",
      ".exp-card:nth-child(5) h3": "Incoming Data Science Co-op",
      ".exp-card:nth-child(5) .exp-company": "Nokia · Ottawa, Canada",
      ".exp-card:nth-child(5) p": "Joining Nokia's data science team in Ottawa for a Fall 2026 co-op.",
      ...
      ".course-card:nth-child(1) .course-term": "Completed Sep 8, 2026",
      ".course-card:nth-child(1) h3": "AI Coding Rules of Engagement - Cursor",
      ".course-card:nth-child(1) p": "Completed Nokia's AI Coding Rules of Engagement training for Cursor (IT00370-W-2026), covering the responsible use of AI-assisted coding at Nokia.",
      ".course-card:nth-child(1) .course-link": "View certificate ->",
      ".course-card:nth-child(2) .course-term": "Completed Jun 30, 2026",
      ".course-card:nth-child(2) h3": "Neural Networks and Deep Learning",
      ".course-card:nth-child(2) p": "Completed an online course authorized by DeepLearning.AI and offered through Coursera, covering neural network foundations and deep learning concepts.",
      ".course-card:nth-child(2) .course-link": "Verify credential ->",
      ".course-card:nth-child(3) .course-term": "Summer 2026",
      ".course-card:nth-child(3) h3": "Industry Project - Kinaxis",
      ".course-card:nth-child(3) p": "Designed and prototyped a multi-tenant AI governance platform with secure tenant isolation, policy-based authorization, governed model routing, and role-aware cascading.",
      ".course-card:nth-child(4) .course-term": "Winter 2026",
      ".course-card:nth-child(4) h3": "Deep Learning & Reinforcement Learning",
      ".course-card:nth-child(4) p": "Neural architectures, backpropagation, CNNs, RNNs, policy gradients, Q-learning, and actor-critic methods.",
      ".course-card:nth-child(5) .course-term": "Winter 2026",
      ".course-card:nth-child(5) h3": "Uncertainty Evaluation in ML (Dropped)",
      ".course-card:nth-child(5) p": "Probabilistic models, Bayesian methods, calibration, conformal prediction, and uncertainty quantification for ML systems.",
      ".course-card:nth-child(6) .course-term": "Winter 2026",
      ".course-card:nth-child(6) h3": "Professional Skills and Responsibility",
      ".course-card:nth-child(6) p": "Professional responsibilities, ethical frameworks in technology, case studies in AI governance, and engineering decision-making.",
  ...
  zh: {
    ...
    text: {
      ...
      ".exp-card:nth-child(5) .tag": "企业实习",
      ".exp-card:nth-child(5) .exp-period": "2026 秋季",
      ".exp-card:nth-child(5) h3": "即将入职的数据科学 Co-op",
      ".exp-card:nth-child(5) .exp-company": "Nokia · 加拿大渥太华",
      ".exp-card:nth-child(5) p": "即将于 2026 秋季加入 Nokia 渥太华数据科学团队。",
      ".exp-card:nth-child(6) .tag": "企业实习",
      ".exp-card:nth-child(6) .exp-period": "2026 夏季",
      ".exp-card:nth-child(6) h3": "工业 AI 工程实习生",
      ".exp-card:nth-child(6) .exp-company": "河北为信电子 · 中国",
      ".exp-card:nth-child(6) p": "在既有 DAS 光纤振动分类系统中，主要负责数据增强、独立测试、交叉验证和 ONNX 推理验证。",
      ...
      ".course-card:nth-child(1) .course-term": "完成于 2026 年 9 月 8 日",
      ".course-card:nth-child(1) h3": "AI 编程参与规则 - Cursor",
      ".course-card:nth-child(1) p": "完成 Nokia 面向 Cursor 的 AI 编程参与规则培训（IT00370-W-2026），学习在 Nokia 负责任地使用 AI 辅助编程。",
      ".course-card:nth-child(1) .course-link": "查看证书 ->",
      ".course-card:nth-child(2) .course-term": "完成于 2026 年 6 月 30 日",
      ".course-card:nth-child(2) h3": "神经网络与深度学习",
      ".course-card:nth-child(2) p": "完成由 DeepLearning.AI 授权并通过 Coursera 提供的在线课程，内容涵盖神经网络基础与深度学习概念。",
      ".course-card:nth-child(2) .course-link": "验证证书 ->",
      ".course-card:nth-child(3) .course-term": "2026 夏季",
      ".course-card:nth-child(3) h3": "行业项目 - Kinaxis",
      ".course-card:nth-child(3) p": "设计并原型实现一个多租户 AI 治理平台，支持安全租户隔离、基于策略的授权、受治理的模型路由和角色感知级联。",
      ".course-card:nth-child(4) .course-term": "2026 冬季",
      ".course-card:nth-child(4) h3": "深度学习与强化学习",
      ".course-card:nth-child(4) p": "学习神经网络架构、反向传播、CNN、RNN、策略梯度、Q-learning 和 actor-critic 方法。",
      ".course-card:nth-child(5) .course-term": "2026 冬季",
      ".course-card:nth-child(5) h3": "机器学习不确定性评估（已退课）",
      ".course-card:nth-child(5) p": "概率模型、贝叶斯方法、校准、保形预测，以及机器学习系统中的不确定性量化。",
      ".course-card:nth-child(6) .course-term": "2026 冬季",
      ".course-card:nth-child(6) h3": "职业技能与责任",
      ".course-card:nth-child(6) p": "职业责任、技术伦理框架、AI 治理案例研究，以及工程决策。",
...
function setLanguage(language) {
  ...
  document.querySelectorAll(".proj-card .card-link, .course-card:nth-child(n+3) .course-link")
